...
export default async function CodListPage({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-5">
      ...
      {isStore2Configured() && <StoreConnectionStatus namespace="cod" />}
      ...
      <div className="grid min-h-0 animate-fade-in auto-rows-[minmax(0,1fr)] gap-4 lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="flex min-h-[12rem] min-w-0 flex-col lg:min-h-0">
          {data.ratesView ? (
            ...
            <div className="flex h-full min-h-[7rem] flex-1 items-center justify-center rounded-card border border-line bg-white/95 p-5 text-center text-[12px] text-muted shadow-soft">
