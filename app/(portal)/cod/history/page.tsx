...
export default async function CodHistoryPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5">
      <section className="animate-fade-up rounded-card border border-[#EBEBEB] border-l-4 border-l-blue-500 bg-white p-5 shadow-soft">
        <h2 className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wider text-blue-800/80">
