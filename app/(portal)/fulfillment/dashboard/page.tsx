  ...
  return (
    ...
    >
      <div className="rounded-card border border-[#EBEBEB] bg-white p-4 shadow-soft">
        <h2 className="text-[13px] font-semibold text-[#111111]">Auto-fulfill cron</h2>
        <p className="mt-1 text-[12px] text-[#555555]">Recent scheduled sync runs</p>
        <div className="mt-3">
          <CronStatus />
        </div>
      </div>
      ...
      <Link
        ...
        className="inline-flex rounded-card border border-[#C25151] bg-[#C25151] px-4 py-2 text-[13px] font-medium text-white transition hover:opacity-90"
      >
