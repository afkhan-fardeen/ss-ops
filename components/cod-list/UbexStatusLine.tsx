...
export function UbexStatusLine({
  ...
  if (!tokenConfigured) {
    return (
      <div className="flex items-start gap-2 rounded-card border border-[#F0B743]/25 bg-[rgba(240,183,67,0.12)] px-3 py-2 text-[12px] text-ink">
  ...
  if (apiMessage) {
    return (
      <div className="flex items-start gap-2 rounded-card border border-[#C25151]/25 bg-[rgba(194,81,81,0.10)] px-3 py-2 text-[12px] text-ink">
    ...
    return (
      <div className="flex items-start gap-2 rounded-card border border-[#C25151]/25 bg-[rgba(194,81,81,0.10)] px-3 py-2 text-[12px] text-ink">
        ...
        <div>
          ...
          <p className="mt-0.5 font-mono text-[11px] text-muted">{error}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex items-start gap-2 text-[12px] text-muted">
      ...
      <p>
        Ubex linked <span className="font-medium text-ink">{linked}</span> of {total} {rowNoun}
        {total === 1 ? "" : "s"}
